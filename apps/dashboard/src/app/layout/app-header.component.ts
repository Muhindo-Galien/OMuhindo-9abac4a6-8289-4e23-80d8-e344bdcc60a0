import { Component, ElementRef, inject, input, output, signal, HostListener } from '@angular/core';
...
@Component({
  ...
  template: `
    <header class="bg-turbovets-navy text-white border-b border-white/10 shadow-sm sticky top-0 z-40">
      <div class="flex items-center justify-between h-14 px-4 sm:px-6">
        ...
        <!-- Logo -->
        <a [routerLink]="['/orgs']" class="flex items-center min-w-0 flex-shrink" aria-label="Sites">
          <img
            [src]="logoUrl()"
            alt="Turbovets"
